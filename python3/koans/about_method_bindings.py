...
class AboutMethodBindings(Koan):
    ...
    def test_functions_have_attributes(self):
        obj = Class()
        self.assertEqual(35, len(dir(function)))  #Defines all of the attributes of the function
        self.assertEqual(True, dir(function) == dir(obj.method.__func__))

    def test_methods_have_different_attributes(self):
        obj = Class()
        self.assertEqual(27, len(dir(obj.method))) #methods have different amount of attributes
